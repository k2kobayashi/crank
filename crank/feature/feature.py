...
"""
Feature extractor for mlfb and mcep
...
class Feature(object):
    def __init__(self, h5_dir, conf, spkr_conf, gl_flag=False):
    ...
    def _analyze_world_features(self, x):
        ...
        for d in range(self.feats["ccap"].shape[-1]):
            ...
            self.feats["cap_uv"][:, d], self.feats["ccap"][:, d] = convert_continuos_f0(
                cap[:, d]
            )
